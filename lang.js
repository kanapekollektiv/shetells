...
const TRANSLATIONS = {
  en: {
    ...
    'archive.about.body':   '<p>This project is artistic research toward a toolkit, a DIY Shell Phone, a device people can build themselves to reclaim agency over technology and use it to remember and observe the ecosystem around them. It has emerged from a child-like gesture of holding a shell to your ear and hearing the ocean.</p><p>Ecology is so often mediated by technological frameworks, which tend to foreground extraction and control. Here, we sought to reorient this relationship, approaching technology as a ritual of care: a process of gleaning narratives, inscribing the memory of water, and listening for the echoes of community voices.</p><p>In Esposende, gleaning once meant sargaço, a long tradition along this coast, carried by the sargaceiras. Researching that history with the scientists who were mentors on our team led us to the kelp forest here and to ocean acidification: how it thins the forest and how that affects the creatures inside it.</p><p>The continuous stream becomes an archive of gathered voices, its contents curated by the environmental data of Esposende. Here, the shifting conditions of the water itself determine which stories emerge and are made audible.</p><p>The installation is the artistic take on the device. Blown glass set into sand: a dune holding a shell, taken from the landscape here. One shell holds the field recordings and a performer imitating them. The other sells you things: Deluxe O2, Sargassum City, Shell Cream, Acid Tabs, Sexy Dunes. A product line built from real problems, sold by She Tells Entity, an entity that advertises to other ocean bodies and never to you. All the products are reflections of what the Esposenders are facing today, starting with sargassum, looking at the effects of ocean acidification on the kelp forest, the future of the kelp, and going all the way to the land with dunes.</p><p>This page is the living archive; everything researched, made and speculated is here.</p><p>Navigate through the map by clicking the tags on the left side of the screen; follow the keyboard.</p><p>The project is realised within the framework of the <a href=\"https://starts.eu/what-we-do/residences/startsaquamotion/\" target=\"_blank\" rel=\"noopener\" style=\"color:inherit;\">S+T+ARTS Aqua Motion</a> artistic residency program, an initiative co-funded by the European Commission and hosted by <a href=\"https://rioneiva.com/\" target=\"_blank\" rel=\"noopener\" style=\"color:inherit;\">Rio Neiva</a>, Esposende, Portugal.</p>',
    'archive.about.mt':     '',
  ...
  pt: {
    ...
    'archive.about':        'sobre',
    'archive.about.title':  'Sea Shells, She Tells',
    'archive.about.body':   "<p>Este projeto é investigação artística com vista a um toolkit, um DIY Shell Phone, um dispositivo que as pessoas podem construir por si próprias para reclamar agência sobre a tecnologia e usá-la para recordar e observar o ecossistema que as rodeia. Nasceu de um gesto de criança: encostar uma concha ao ouvido e ouvir o oceano.</p><p>A ecologia é tantas vezes mediada por estruturas tecnológicas, que tendem a colocar em primeiro plano a extração e o controlo. Aqui, procurámos reorientar essa relação, abordando a tecnologia como um ritual de cuidado: um processo de apanhar narrativas, inscrever a memória da água e escutar os ecos das vozes da comunidade.</p><p>Em Esposende, a apanha significou em tempos o sargaço, uma longa tradição ao longo desta costa, levada pelas sargaceiras. Investigar essa história com os cientistas que foram mentores da nossa equipa levou-nos à floresta de algas daqui e à acidificação do oceano: como esta torna a floresta mais rala e como isso afeta as criaturas que nela vivem.</p><p>A transmissão contínua torna-se um arquivo de vozes recolhidas, cujo conteúdo é curado pelos dados ambientais de Esposende. Aqui, são as condições mutáveis da própria água que determinam que histórias emergem e se tornam audíveis.</p><p>A instalação é a leitura artística do dispositivo. Vidro soprado assente na areia: uma duna a segurar uma concha, retirada da paisagem daqui. Uma concha guarda as gravações de campo e uma performer a imitá-las. A outra vende-te coisas: Deluxe O2, Sargassum City, Shell Cream, Acid Tabs, Sexy Dunes. Uma linha de produtos construída a partir de problemas reais, vendida pela She Tells Entity, uma entidade que anuncia a outros corpos oceânicos e nunca a ti. Todos os produtos são reflexos daquilo que os esposendenses enfrentam hoje, começando pelo sargaço, passando pelos efeitos da acidificação do oceano na floresta de algas, o futuro das algas, e chegando até à terra com as dunas.</p><p>Esta página é o arquivo vivo; tudo o que foi investigado, feito e especulado está aqui.</p><p>Navega pelo mapa clicando nas etiquetas do lado esquerdo do ecrã; segue o teclado.</p><p>O projeto é realizado no âmbito do programa de residência artística <a href=\"https://starts.eu/what-we-do/residences/startsaquamotion/\" target=\"_blank\" rel=\"noopener\" style=\"color:inherit;\">S+T+ARTS Aqua Motion</a>, uma iniciativa co-financiada pela Comissão Europeia e acolhida pelo <a href=\"https://rioneiva.com/\" target=\"_blank\" rel=\"noopener\" style=\"color:inherit;\">Rio Neiva</a>, Esposende, Portugal.</p>",
