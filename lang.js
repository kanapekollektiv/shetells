...
const TRANSLATIONS = {
  en: {
    ...
    'shell.source': '↗ Ocean acidification and calcifying marine life',
    'acid.source': '↗ The pH record of the Iberian upwelling system',
    'spiral.source': '↗ Litter and pressures on the dune environment',
    'sargassum.source': '↗ Sargassum as habitat',
    'o2.source': '↗ Blue carbon reading',
    ...
    'archive.about':        'about',
    'archive.about.title':  'Sea Shells, She Tells',
    'archive.about.lessbtn': 'Read less',
    'archive.about.morebtn': 'Read more about the project',
    'archive.about.more': '<p>In Esposende, gleaning has historically meant sargaço, a practice carried by the sargaceiras along this coastline. The toolkit speculates a ritual for reclaiming agency in relation to technology, transposing the gleaning of seaweed into a gathering of memories, speculations, and echoes - voices of the waters and their inhabitants.</p><p>Both the artistic work and the toolkit open access to the gleaned stories of the region, residing within an ongoing, online stream that remains accessible through the toolkit. This stream continues to unfold, receptive to future contributions and new narratives.</p><p>The continuous stream becomes an archive of gathered voices, its contents curated by the environmental data of Esposende. Here, the shifting conditions of the water itself determine which stories emerge and are made audible.</p><p>Ecological experience is frequently shaped by technological frameworks that privilege extraction and control. In this context, the project seeks to reconfigure the relationship, approaching technology as a ritual of care - a process of gathering narratives, inscribing the memory of water, and attuning to the echoes of community voices.</p><p>The installation materialises as an artistic interpretation of the device: blown glass embedded in sand, forming a dune that cradles a shell sourced from the local landscape. One shell contains field recordings and their performed imitations; the other proposes a catalogue of products: Deluxe O2, Sargassum City, Shell Cream, Acid Tabs, Sexy Dunes. These offerings, presented by She Tells Entity, are addressed to other oceanic bodies, never to the human observer. The research, initiated with sargassum, expanded into the present and future conditions of the kelp forest and its influencing factors. Each product reflects the lived realities of Esposende, tracing a line from sargassum to ocean acidification, from kelp futures to the shifting contours of the dunes.</p>',
    'archive.about.body':   '<p>Sea Shells, She Tells unfolds as an artistic research project, developing both an artwork, an installation of the Shetells artwork - and a toolkit - the DIY Shell Phone. The project emerges from the simple, almost childlike gesture of holding a shell to the ear, hearing the ocean’s presence. This toolkit is conceived as a means for the waters of Esposende to exchange with their inhabitants, enabling acts of observation, remembrance, and speculation about the futures of water bodies. Through this, a playful voice is extended to the non-human presences and aquatic landscapes of the ecosystem.</p><p>A living archive gathers here, composed of histories and speculative futures that have emerged through research in dialogue with the community of Esposende.</p><p>Navigate the map by clicking the tags on the left side of the screen; follow the keyboard prompts.</p><p>The project is realised within the framework of the <a href="https://starts.eu/what-we-do/residences/startsaquamotion/" target="_blank" rel="noopener" style="color:inherit;">S+T+ARTS Aqua Motion</a> artistic residency program, an initiative co-funded by the European Commission and hosted by <a href="https://rioneiva.com/" target="_blank" rel="noopener" style="color:inherit;">Rio Neiva</a>, Esposende, Portugal.</p><p>See our <a href="team.html" style="color:inherit;">team</a> section to find out about who we are!</p>',
    'archive.about.mt':     '',
    'archive.audio.en':     'in english',
    'archive.audio.pt':     'in portuguese',
    'archive.audio.play':   'Play',
  ...
  pt: {
    ...
    'shell.source': '↗ Acidificação dos oceanos e vida marinha calcificante',
    'acid.source': '↗ O registo de pH do sistema de afloramento ibérico',
    'spiral.source': '↗ Lixo e pressões sobre o ambiente dunar',
    'sargassum.source': '↗ O sargaço como habitat',
    'o2.source': '↗ Leitura sobre carbono azul',
    ...
    'archive.about':        'sobre',
    'archive.about.title':  'Sea Shells, She Tells',
    'archive.about.lessbtn': 'Ler menos',
    'archive.about.morebtn': 'Ler mais sobre o projeto',
    'archive.about.more': '<p>Em Esposende, a apanha significou historicamente o sargaço, uma prática levada pelas sargaceiras ao longo desta costa. O toolkit especula um ritual para reclamar agência em relação à tecnologia, transpondo a apanha de algas para uma recolha de memórias, especulações e ecos - vozes das águas e dos seus habitantes.</p><p>Tanto a obra artística como o toolkit abrem acesso às histórias recolhidas da região, que residem numa transmissão online contínua, acessível através do toolkit. Essa transmissão continua a desdobrar-se, recetiva a contribuições futuras e a novas narrativas.</p><p>A transmissão contínua torna-se um arquivo de vozes recolhidas, cujo conteúdo é curado pelos dados ambientais de Esposende. Aqui, são as condições mutáveis da própria água que determinam que histórias emergem e se tornam audíveis.</p><p>A experiência ecológica é frequentemente moldada por estruturas tecnológicas que privilegiam a extração e o controlo. Neste contexto, o projeto procura reconfigurar essa relação, abordando a tecnologia como um ritual de cuidado - um processo de recolher narrativas, inscrever a memória da água e sintonizar-se com os ecos das vozes da comunidade.</p><p>A instalação materializa-se como uma interpretação artística do dispositivo: vidro soprado embutido na areia, formando uma duna que acolhe uma concha proveniente da paisagem local. Uma concha contém gravações de campo e as suas imitações performadas; a outra propõe um catálogo de produtos: Deluxe O2, Sargassum City, Shell Cream, Acid Tabs, Sexy Dunes. Estas ofertas, apresentadas pela She Tells Entity, são dirigidas a outros corpos oceânicos, nunca ao observador humano. A investigação, iniciada com o sargaço, expandiu-se para as condições presentes e futuras da floresta de algas e para os fatores que a influenciam. Cada produto reflete as realidades vividas de Esposende, traçando uma linha do sargaço à acidificação do oceano, dos futuros das algas aos contornos mutáveis das dunas.</p>',
    'archive.about.body':   '<p>Sea Shells, She Tells desdobra-se como um projeto de investigação artística, desenvolvendo tanto uma obra, uma instalação da obra Shetells - como um toolkit - o DIY Shell Phone. O projeto nasce do gesto simples, quase infantil, de encostar uma concha ao ouvido e ouvir a presença do oceano. Este toolkit é concebido como um meio para as águas de Esposende trocarem com os seus habitantes, permitindo atos de observação, memória e especulação sobre os futuros dos corpos de água. Através disso, é estendida uma voz lúdica às presenças não humanas e às paisagens aquáticas do ecossistema.</p><p>Reúne-se aqui um arquivo vivo, composto por histórias e futuros especulativos que emergiram da investigação em diálogo com a comunidade de Esposende.</p><p>Navega pelo mapa clicando nas etiquetas do lado esquerdo do ecrã; segue as indicações do teclado.</p><p>O projeto é realizado no âmbito do programa de residência artística <a href="https://starts.eu/what-we-do/residences/startsaquamotion/" target="_blank" rel="noopener" style="color:inherit;">S+T+ARTS Aqua Motion</a>, uma iniciativa co-financiada pela Comissão Europeia e acolhida pelo <a href="https://rioneiva.com/" target="_blank" rel="noopener" style="color:inherit;">Rio Neiva</a>, Esposende, Portugal.</p><p>Vê a secção da nossa <a href="team.html" style="color:inherit;">equipa</a> para saberes quem somos!</p>',
    'archive.about.mt':     'Tradução automática. Será revista por um tradutor.',
    'archive.audio.en':     'em inglês',
    'archive.audio.pt':     'em português',
    'archive.audio.play':   'Ouvir',
    ...
    /* ── Info overlay ── */
    'info.body':            '<p>Bem-vindos ao Sea Shells, She Tells, convidamos-te a ouvir, lembrar e participar. Aqui, perguntamos: como és moldado pela água? Que histórias guardam para ti as águas de Esposende? Para onde vão as nossas memórias dormir no fluxo eterno da nuvem invisível da tecnologia?<br><br>Desejamos as tuas memórias, adiciona a tua ao nosso <a href="memories.html" style="color:inherit;">stream eterno!</a> Este arquivo em constante crescimento está no coração do Sea Shells, She Tells: uma obra de arte contínua onde as tuas histórias sobre a água se unem às de outros, formando um reservatório coletivo. Talvez um dia o leiloemos ao maior licitante. Brincadeira... ou será que não? Abertos a ideias!<br><br>Ao explorar, mergulhe nos nossos produtos especulativos que criámos para os corpos de água e as entidades não humanas de Esposende, que já estamos a vender: shell cream, acid tabs, sexy dunes, deluxe o&#x2082;, e the shell phone.<br><br>Até que a tua história se torne parte da nossa, o stream eterno está cheio do que temos a dizer, mas não gostaríamos de ser os únicos a falar, então partilha as tuas memórias! Em breve, também poderás aceder ao stream eterno por meio do nosso próximo produto fabuloso: o DIY shell phone, um dispositivo lúdico que permite conectar-se a ele de qualquer lugar.<br><br>E também temos um novo lançamento; para os habitantes da terra, não perca as nossas luxuosas Hypersea Atmospheres: altares soprados em vidro personalizados, criados para guardar as tuas memórias num lugar especial em casa. <a href="https://www.instagram.com/p/DZxi-N6DWOJ/?img_index=1" target="_blank" rel="noopener" style="color:inherit;">Veja aqui!</a><br><br>Com amor,<br><br><a href="team.html" style="color:inherit;">equipa She Tells</a><br><br>O projeto é realizado no âmbito do programa de residência artística <a href="https://starts.eu/what-we-do/residences/startsaquamotion/" target="_blank" rel="noopener" style="color:inherit;">S+T+ARTS Aqua Motion</a>, uma iniciativa co-financiada pela Comissão Europeia e acolhida pelo <a href="https://rioneiva.com/" target="_blank" rel="noopener" style="color:inherit;">Rio Neiva</a>, Esposende, Portugal.</p>',
