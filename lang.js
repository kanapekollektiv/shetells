...
const TRANSLATIONS = {
  en: {
    ...
    /* ── Info overlay ── */
    'info.body':            '<p>Welcome to Sea Shells, She Tells, we invite you to listen, remember, and participate. Here, we ask: how are you shaped by water? What stories does water hold for you? Where do our memories go to sleep on the eternal stream of the invisible cloud of tech?<br><br>We crave your memories, add yours to our eternal stream! This ever-growing archive is at the heart of Sea Shells, She Tells: an ongoing artwork where your water stories join those of others, forming a collective reservoir. Maybe one day we\'ll auction it to the highest bidder. Just kidding... or are we? Open to ideas!)<br><br>As you explore, immerse yourself in our speculative product line, which we are already selling: shell cream, acid tabs, sexy dunes, deluxe o&#x2082;, and the shell phone.<br><br>Until your story becomes part of ours, listen to the stream and discover our esteemed product lines. Soon, you\'ll also be able to access the eternal stream via our next fabulous product: the DIY shell phone, a playful device that lets you connect to it from anywhere.<br><br>And we also have a new hot drop; for land dwellers, don\'t miss our deluxe Hypersea Atmospheres: custom glass-blown altars designed to hold your memories in a special place at home. <a href="https://www.instagram.com/p/DZxi-N6DWOJ/?img_index=1" target="_blank" rel="noopener" style="color:inherit;">Check them out here!</a><br><br>By "we," we mean our <a href="team.html" style="color:inherit;">team</a>, a group of artists, researchers, and collaborators passionate about water, memory, and creative participation.<br><br>The project is realised within the framework of the <a href="https://starts.eu/what-we-do/residences/startsaquamotion/" target="_blank" rel="noopener" style="color:inherit;">S+T+ARTS Aqua Motion</a> artistic residency program, an initiative co-funded by the European Commission and hosted by <a href="https://rioneiva.com/" target="_blank" rel="noopener" style="color:inherit;">Rio Neiva</a>, Esposende, Portugal.</p>',
  ...
  pt: {
    ...
    /* ── Info overlay ── */
    'info.body':            '<p>Bem-vindos ao Sea Shells, She Tells, convidamos você a ouvir, lembrar e participar. Aqui, perguntamos: como você é moldado pela água? Que histórias a água guarda para você? Para onde vão as nossas memórias dormir no fluxo eterno da nuvem invisível da tecnologia?<br><br>Desejamos as suas memórias, adicione a sua ao nosso stream eterno! Este arquivo em constante crescimento está no coração do Sea Shells, She Tells: uma obra de arte contínua onde as suas histórias sobre a água se unem às de outros, formando um reservatório coletivo. Talvez um dia o leiloemos ao maior licitante. Brincadeira... ou será que não? Abertos a ideias!)<br><br>Ao explorar, mergulhe na nossa linha de produtos especulativos, que já estamos vendendo: shell cream, acid tabs, sexy dunes, deluxe o&#x2082;, e the shell phone.<br><br>Até que a sua história se torne parte da nossa, ouça o stream e descubra as nossas estimadas linhas de produtos. Em breve, você também poderá acessar o stream eterno por meio do nosso próximo produto fabuloso: o DIY shell phone, um dispositivo lúdico que permite conectar-se a ele de qualquer lugar.<br><br>E também temos um novo lançamento; para os habitantes da terra, não perca nossas luxuosas Hypersea Atmospheres: altares soprados em vidro personalizados, criados para guardar as suas memórias em um lugar especial em casa. <a href="https://www.instagram.com/p/DZxi-N6DWOJ/?img_index=1" target="_blank" rel="noopener" style="color:inherit;">Confira aqui!</a><br><br>Quando dizemos "nós", nos referimos à nossa <a href="team.html" style="color:inherit;">equipe</a>, um grupo de artistas, pesquisadores e colaboradores apaixonados por água, memória e participação criativa.<br><br>O projeto é realizado no âmbito do programa de residência artística <a href="https://starts.eu/what-we-do/residences/startsaquamotion/" target="_blank" rel="noopener" style="color:inherit;">S+T+ARTS Aqua Motion</a>, uma iniciativa co-financiada pela Comissão Europeia e acolhida pelo <a href="https://rioneiva.com/" target="_blank" rel="noopener" style="color:inherit;">Rio Neiva</a>, Esposende, Portugal.</p>',
