...
const TRANSLATIONS = {
  en: {
    ...
    /* ── Info overlay ── */
    'info.body':            '<p>Our project, Sea Shells, She Tells, is about remembering that we are all water in some way. We are developing a collective archive of water memories in our eternal stream — which you can be part of by donating a memory of yours on this website, or just listening to our stream here.<br><br>You can meet our speculative corporation and our first fictional product line offline as well in our Portugese showroom in <a href="https://www.visitesposende.com/en/fazer/monumentos/sargasso-museum" target="_blank" rel="noopener" style="color:inherit;">Sargasso Museum</a>.<br><br>By the way, by we, we mean our <a href="team.html" style="color:inherit;">team</a>.<br><br>Please take your time to surf around on this site! There is no rush.<br><br>The project is realised within the framework of the <a href="https://starts.eu/what-we-do/residences/startsaquamotion/" target="_blank" rel="noopener" style="color:inherit;">S+T+ARTS Aqua Motion</a> artistic residency program, an initiative co-funded by the European Commission and hosted by <a href="https://rioneiva.com/" target="_blank" rel="noopener" style="color:inherit;">Rio Neiva</a>, Esposende, Portugal.</p>',
