...
const TRANSLATIONS = {
  en: {
    ...
    /* ── Info overlay ── */
    'info.body':            '<p>Welcome to Sea Shells, She Tells, we invite you to listen, remember, and participate. Here, we ask: how are you shaped by water? What stories does water hold for you?</p><p>We crave your memories, add yours to our eternal stream! This ever-growing archive is at the heart of Sea Shells, She Tells: an ongoing artwork where your water stories join those of others, forming a collective reservoir. Maybe one day we\'ll auction it to the highest bidder. Just kidding... or are we? Open to ideas!)</p><p>As you explore, immerse yourself in our speculative product line, which we are already selling: shell cream, acid tabs, sexy dunes, deluxe o&#x2082;, and the shell phone.</p><p>Until your story becomes part of ours, listen to the stream and discover our esteemed product lines. Soon, you\'ll also be able to access the eternal stream via our next fabulous product: the DIY shell phone, a playful device that lets you connect to it from anywhere.</p><p>And we also have a new hot drop; for land dwellers, don\'t miss our deluxe Hypersea Atmospheres: custom glass-blown altars designed to hold your memories in a special place at home. (Check them out here: <a href="https://www.instagram.com/p/DZxi-N6DWOJ/?img_index=1" target="_blank" rel="noopener" style="color:inherit;">Instagram</a>)</p><p>By "we," we mean our <a href="team.html" style="color:inherit;">team</a>, a group of artists, researchers, and collaborators passionate about water, memory, and creative participation.</p><p>The project is realised within the framework of the <a href="https://starts.eu/what-we-do/residences/startsaquamotion/" target="_blank" rel="noopener" style="color:inherit;">S+T+ARTS Aqua Motion</a> artistic residency program, an initiative co-funded by the European Commission and hosted by <a href="https://rioneiva.com/" target="_blank" rel="noopener" style="color:inherit;">Rio Neiva</a>, Esposende, Portugal.</p>',
  ...
  pt: {
    ...
    /* ── Info overlay ── */
    'info.body':            '<p>Nosso projeto, Sea Shells, She Tells, é sobre lembrar que somos todos água de alguma forma. Estamos desenvolvendo um arquivo coletivo de memórias aquáticas no nosso stream eterno — do qual você pode fazer parte doando uma memória sua neste site, ou apenas ouvindo o nosso stream aqui.<br><br>Você também pode encontrar nossa corporação especulativa e nossa primeira linha de produtos fictícios offline na nossa sala de exposição portuguesa no <a href="https://www.visitesposende.com/en/fazer/monumentos/sargasso-museum" target="_blank" rel="noopener" style="color:inherit;">Sargasso Museum</a>.<br><br>Aliás, quando dizemos "nós", nos referimos à nossa <a href="team.html" style="color:inherit;">equipe</a>.<br><br>Fique à vontade para explorar o site com calma! Não há pressa.<br><br>O projeto é realizado no âmbito do programa de residência artística <a href="https://starts.eu/what-we-do/residences/startsaquamotion/" target="_blank" rel="noopener" style="color:inherit;">S+T+ARTS Aqua Motion</a>, uma iniciativa co-financiada pela Comissão Europeia e acolhida pelo <a href="https://rioneiva.com/" target="_blank" rel="noopener" style="color:inherit;">Rio Neiva</a>, Esposende, Portugal.</p>',
