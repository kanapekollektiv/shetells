...
const TRANSLATIONS = {
  en: {
    ...
    'mem.q4':      'Wonderful!\nWe can\'t wait to hear your voice!\n\nOne last thing, before you send us your memory:\nYour voice is going to be recorded and it\'s going to be uploaded to our public platform. We are not going to train any AI on your voice and we don\'t want to use your recording for any other purpose other than this art project.\nBut please be mindful that others will hear your memories, so only share information that you are comfortable with sharing.\nYou have the right to retrieve your memory for two weeks after the recording by sending us an email at kanape.kollektiv@gmail.com!\n\nWe will ask you for your email address, so we can send you a message when your memory is uploaded to the stream, and if we have groundbreaking news on our project. We promise we won\'t litter your folder (unlike humans littering our waters).',
    ...
    'mem.btn.dislikeWater': 'I dislike water.',
  ...
  pt: {
    ...
    'mem.q4':      'Maravilhoso!\nMal podemos esperar para ouvir a sua voz!\n\nUma última coisa, antes de nos enviar a sua memória:\nA sua voz será gravada e carregada na nossa plataforma pública. Não vamos treinar nenhuma IA com a sua voz e não queremos usar a sua gravação para qualquer outro propósito além deste projeto artístico.\nMas esteja ciente de que outros ouvirão as suas memórias, portanto, compartilhe apenas informações com as quais se sinta confortável.\nVocê tem o direito de recuperar a sua memória por duas semanas após a gravação enviando um email para kanape.kollektiv@gmail.com!\n\nPediremos o seu endereço de email, para que possamos enviar uma mensagem quando a sua memória for carregada no stream e se tivermos novidades importantes sobre o projeto. Prometemos não encher a sua caixa de entrada (ao contrário dos humanos que poluem as nossas águas).',
    ...
    'mem.btn.dislikeWater': 'Não gosto de água.',
