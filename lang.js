...
const TRANSLATIONS = {
  ...
  pt: {
    ...
    'o2.title':             'deluxe o₂',
    'o2.body':              'Você está cansada do seu oxigénio de sempre, vindo daquelas árvores verdes feias?',
    'o2.bold':              'Respire melhor, querida!',
    'o2.disclaimer':        '<strong>Aviso:</strong> Consuma nosso oxigénio premium apenas se a evolução tiver te equipado com os órgãos adequados para o processar.',
    ...
    'sargassum.disclaimer': '<strong>Aviso:</strong> A Sargassum City não se responsabiliza pelas alterações climáticas, emissões de carbono ou pelo plástico no seu corpo. Se algum destes sintomas ocorrer na sua região, consulte o seu médico ou farmacêutico.',
    ...
    'mem.q3.dislike': 'Tudo bem, querida.\n\nMas 55 a 65% de você é água, queira ou não. A mesma água continua a circular por corpos, nuvens e mares. As nossas memórias já partilham uma corrente.\n\nEstamos construindo um arquivo. Um fluxo de memórias aquáticas atravessa a nuvem invisível. Você consegue pensar numa memória que gostaria de lançar no nosso fluxo eterno?',
    'mem.q3.neutral': 'Neutro. Como água parada antes que a maré vire.\n\nSe somos principalmente água e a mesma água continua a circular por corpos, nuvens e mares, nossas memórias já partilham uma corrente.\n\nEstamos construindo um arquivo. Um fluxo de memórias aquáticas atravessa a nuvem invisível. Você consegue pensar numa memória que gostaria de lançar no nosso fluxo eterno?',
    'mem.q3.love':    'Achávamos que você diria isso.\n\nSe somos principalmente água e a mesma água continua a circular por corpos, nuvens e mares, então nossas memórias já partilham uma corrente.\n\nEstamos construindo um arquivo. Um fluxo de memórias aquáticas atravessa a nuvem invisível. Você consegue pensar numa memória que gostaria de lançar no nosso fluxo eterno?',
    ...
    'mem.q4html':  'Maravilhoso!<br>Mal podemos esperar para ouvir a sua voz.<br><br>Só antes de partilhar:<br><br><strong>Sua voz será pública.</strong> Partilhe apenas o que você se sentir confortável em partilhar.<br><br>Não vamos treinar nenhuma IA com ela, nem usá-la para nada além desta obra de arte.<br><br>Mudou de ideia? Envie-nos um email em até duas semanas:<br><span style="font-family:\'Celescript\',cursive;">kanape.kollektiv@gmail.com</span><br><br>Pediremos o seu email para te avisar quando sua memória se juntar ao stream.',
